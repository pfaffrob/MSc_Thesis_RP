...
{{< print-acronyms include_unused=false title='' >}}
...
## Train metrics single-site {.unnumbered .unlisted}
...
Train metrics from the best performing single-site model for site A2 trained on relatively calibrated {{< acr MS >}} data using {{< acr DICE >}}.
:::

## Train metrics multi-site {.unnumbered .unlisted}
...
### Kauri Glen {.unnumbered .unlisted}
...
### Hammond Park {.unnumbered .unlisted}
...
## Best Multi-Site Models {.unnumbered .unlisted}
...
## Multi-Site Models all Configurations {.unnumbered .unlisted}
